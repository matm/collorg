...
def _get_start_state(self):
    ...
    start_state_.cog_oid_.value = self.start_state_
    return start_state_
def _set_start_state(self, start_state_):
    self.start_state_.value = start_state_.cog_oid_
...
def _get_end_state(self):
    ...
    end_state_.cog_oid_.value = self.end_state_
    return end_state_
def _set_end_state(self, end_state_):
    self.end_state_.value = end_state_.cog_oid_
