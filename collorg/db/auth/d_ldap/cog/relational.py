...
def _get_connectivity_security(self):
    ...
    connectivity_security_.cog_oid_.value = self.connectivity_security_
    return connectivity_security_
def _set_connectivity_security(self, connectivity_security_):
    self.connectivity_security_.value = connectivity_security_.cog_oid_
...
def _get_certificate_checks(self):
    ...
    certificate_checks_.cog_oid_.value = self.certificate_checks_
    return certificate_checks_
def _set_certificate_checks(self, certificate_checks_):
    self.certificate_checks_.value = certificate_checks_.cog_oid_
...
def _get_scope(self):
    ...
    scope_.cog_oid_.value = self.scope_
    return scope_
def _set_scope(self, scope_):
    self.scope_.value = scope_.cog_oid_
